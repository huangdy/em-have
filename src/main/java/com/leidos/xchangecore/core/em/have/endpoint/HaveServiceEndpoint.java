package com.leidos.xchangecore.core.em.have.endpoint;
...
public class HaveServiceEndpoint implements ServiceNamespaces {
	 ...
	 * @see <a href=
	 *      "services/ResourceManagement/0.1/ResourceManagementService.xsd">Appendix:
	 *      ResourceManagementService.xsd</a>
	 * @see <a href=
	 *      "services/ResourceManagement/0.1/ResourceManagementServiceData.xsd">Appendix:
	 *      ResourceManagementServiceData.xsd</a>
	 * @see <a href=
	 *      "http://docs.oasis-open.org/emergency/edxl-de/v1.0/EDXL-DE_Spec_v1.0.pdf">OASIS
	 *      EDXL-DE Specification</a>
	 * @see <a href=
	 *      "http://docs.oasis-open.org/emergency/edxl-rm/v1.0/EDXL-RM-SPEC-V1.0.pdf">OASIS
	...
	public EdxlDeResponseDocument edxldeRequest(EdxlDeRequestDocument requestDoc) {
		...
		try {
			...
			response.getEdxlDeResponse().setErrorExists(true);
			response.getEdxlDeResponse().setErrorString("Failure to send message to one or more cores");
