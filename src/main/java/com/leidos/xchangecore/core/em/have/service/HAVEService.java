...
public interface HAVEService {
	 ...
	 * 
	 * @param request
	 *            - EDXLDistribution containing HAVE Message
	 ...
	 * @ssdd
	 */
	public EdxlDeResponseDocument edxldeRequest(EDXLDistribution request) throws IllegalArgumentException,
			EmptyCoreNameListException, SendMessageErrorException, LocalCoreNotOnlineException;

	/**
	 * Gets a list of HAVE work products for an incident if the id is not null or
	 * empty.
	 * 
	 * @param incidentID
